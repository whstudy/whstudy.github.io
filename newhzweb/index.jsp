                    ...
                    <div class="header" style="height:45px;padding-left: 50px;">
                        <div class="container" style="">
                            <div class="row">
                                ...
                                <div class="col-xs-3" style="font-size:16px;width: auto;">
...
/*                                         background: #B4ACAC; */
                                        ">
                                             ...
                                             <span ng-show="call&&call!=' '" ng-bind="call"></span>
                                             <span ng-show="!call||call==' '" ng-bind="username"></span>
...
<!-- ng-click="fnChangeUser(user.userName,$index)" -->
                                            <li ng-repeat="user in users" ng-click="$root.fnChangeUser(user.userName,$index)">
                                                <a option="user.userName" href="javascript:void(0)">

                                                	<span ng-show="user.call&&user.call!=' '">{{user.call}}</span>
                                                	<span ng-show="!user.call||user.call==' '">{{user.name}}</span>                                                	
                                ...
                                <div class="col-xs-3">
                                    <div class="top-menu pull-right">
                                        <a data-toggle="dropdown" data-target="#" style="color:#e9e9e9;font-size:16px;cursor:pointer;">
                                            ...
                                            <span ng-click="aa();" class="username">
                                                <small>
                                                    个人中心
                                                </small>
                                            </span>
                                    ...
                                    <div class="profile-nav col-xs-5">
                                        <div class="panel ">
                                            <div class="user-heading round">
                                                <a href="#">
<!--                                                     <img src="{{o.pic? 'file/processDownload?file=' +o.pic:'img/pro-ac-1.png'}}" alt=""> -->
                                                    <img ng-src="{{imgUrl}}" alt="">
                                                </a>
                                                
                                                <h1 ng-if="!call||call==' '" ng-bind="username">
                                                </h1>
                                                <h1 ng-if="call&&call!=' '" ng-bind="call">
                                                </h1>                                                     
